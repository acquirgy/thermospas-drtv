		...
		<div id="wrapper">
			...
			<header id="header">
				...
				<div class="main-image">
					<img src="/assets/images/img011.jpg" height="128" alt="image description">
				</div>
				...
				<section id="content">
					...
					<div class="media-block">
						...
						<p>Just click the links below to view or download content.</p>
						 <ul class="media-list">
                        <li><a href="http://www.thermospas.com/wp-content/plugins/ts_form/downloads/Full_Series_Brochure.pdf"
                                target="_blank">
                            <img src="/assets/images/img12.png" alt="image description">
                            <span>Download the ThermoSpas Brochure PDF file (4.3 MB)</span> </a></li>
